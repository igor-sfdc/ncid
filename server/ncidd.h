...
#endif
#ifndef HUPEXTENSION
#define HUPEXTENSION   "hangup-skel"
#endif
#ifndef EXTDIR
#define EXTDIR      "/usr/local/share/ncid/extensions"
#endif
#ifndef RECORDING
#define RECORDING   "NumberDisconnected.rmd"
#endif
#ifndef ANNDIR
#define ANNDIR      "/usr/local/share/ncid/recordings"
#endif

#define STDOUT      1
#define CHARWAIT    2       /* deciseconds */
#define READWAIT    100000  /* microseconds */
#define READTRY     60      /* number of times to INITWAIT for a character */
#define TTYSPEED    B115200
#define RAW         1
#define NOTRAW      0

#define SEND_TIMEOUT 15     /* seconds */
...
#define DOEXTEND    "%s \"*DATE*%s*TIME*%s*LINE*%s*NMBR*%s*NAME*%s*\" 2>&1"
#define HUPNAME     "hangup"
#define RECFILE     "Recording:"

/* server warning messages */
#define LOG2BIG     "MSG: Call Log too big: (%lu > %lu) bytes %s%s"
#define TOOMANY     "MSG: Too many clients connected (%d) %s%s"
...
#define RELOAD      "REQ: RELOAD" /* reload alias, blacklist, whitelist files */
#define UPDATE      "REQ: UPDATE"  /* update current CID call log file */
#define UPDATES     "REQ: UPDATES" /* update all of the CID call log files */
#define REREAD      "REQ: REREAD"  /* reread current CID call log file */
...
#define HELLO       "HELLO: "
#define IDENT       "HELLO: IDENT: "
#define COMMAND     "HELLO: CMD: "
...
extern char *initstr, *initcid, *hupname, *huprmd;
extern char *cidlog, *datalog, *lineid, *lockfile, *pidfile, *fnptr;
extern char *announce, annpath[];
extern int setcid, port, clocal, ttyspeed, ttyfd, hangup, hupmode;
...
extern void logMsg();
extern int errorExit(), CheckForLockfile(), openTTY(), setTTY();
extern int setModem(), initModem();
